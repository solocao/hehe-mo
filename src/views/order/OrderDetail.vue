    ...
    <group style="margin-bottom: 50px;">
      ...
      <cell-box is-link v-show="storeInfo.show">
        <div class="store">
          <p>发货门店</p>
          <p>
            <span>门店名称：</span>上海欧冰蓝贸易有限公司</p>
          <p>
            <span>门店地址：</span>上海市宝山区昌邑路15号简配路B馆</p>
          <p>
            <span>门店电话：</span>021-12374125</p>
        </div>
      </cell-box>
      ...
      <cell inline-desc="共两件">
        <div>
          小计&nbsp;￥
          <span style="color:#393a3e;font-size: 16px;">247100.00</span>
        </div>
      </cell>
    </group>

<template>
  <div class="category">
    <ul class="category-menu vux-1px-r">
      <li v-for="(item,index) in menu" :key="index" class="menu-item" :class="[currentIndex === index?'active':'']" @click="switchCategory(index,item.id)">
        {{item.name}}
      </li>
    </ul>
    <div class="category-main">
      <div class="category-detail-box">
        ...
        <div class="category-list">
          <div class="category-goods-items" v-for="(item,index) in list" @click="linktoDetail(item.id)" :key="index">
            <img :src="item.main_img_url" alt="" class="goods-image">

<template>
	<div class="good-list-wrap" v-if="type === 'SUBINFO'">
	...
	<div class="good-list-wrap" v-else-if="type==='SUBINFOS'">
		<img class="good-list-img" :src="data.img" alt="">
		<div class="good-list-info">
			<div class="title z-ellipsis-2">
				{{data.title}}
			...
			<div class="subInfo z-ellipsis-2">
				<span class="param" v-for="item in data.subInfo">
					{{item}}
				</span>
			</div>
			<div class="price">
				￥{{data.price}}
				<span class="num" v-if="data.num">
					x{{data.num}}
				</span>
			</div>
		</div>

<template>
  <div class="cart-card-wrap">
    <div @click="selectHandler" class="cart-card-select">
      <icon class="icon" :type="selected ? 'success' : 'circle'">
      </icon>
    </div>
    <div class="cart-card-info">
      ...
      <div class="cart-card-desc">
        ...
        <x-number class="accumulator" :title="''" v-model="num" button-style="round" @on-change="change" :step="1" :value="1" :min="0">
        </x-number>
      </div>
    </div>
